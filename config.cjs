...
module.exports = {
  "SESSION_ID": process.env.SESSION_ID || "SUBZERO-MD~TY0oLwaggNoFM5IvBtox",
  ...
  "OWNER_NUMBER": process.env.OWNER_NUMBER || "6285280319856",
  "OWNER_NAME": process.env.OWNER_NAME || "Evan",
